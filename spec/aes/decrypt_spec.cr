...
describe AES::Utils do
  describe "decrypt" do
    it "should decrypt case 1 in ECB mode" do
      u = AES::Utils.new(128, AES::Mode::ECB, AES::Process::Decrypt)
      ciphertext = [
      ...
      plaintext = u.process(ciphertext, key)
      plaintext.should eq [
    ...
    it "should decrypt case 1 in CBC mode" do
      u = AES::Utils.new(128, AES::Mode::CBC, AES::Process::Decrypt)
      ciphertext = [
        0x8d, 0x04, 0xff, 0xf2, 0x7a, 0x08, 0x1a, 0x77,
        0xde, 0x20, 0x09, 0xd1, 0x40, 0x2e, 0x6e, 0x03,
    ...
    it "should decrypt case 2 in ECB mode" do
      # Tests multiple blocks
      u = AES::Utils.new(192, AES::Mode::ECB, AES::Process::Decrypt)
      ciphertext = [
    ...
    it "should decrypt case 2 in CBC mode" do
      # Tests multiple blocks
      u = AES::Utils.new(192, AES::Mode::CBC, AES::Process::Decrypt)
      ciphertext = [
        0x9e, 0x28, 0x0d, 0xc6, 0x37, 0x39, 0x39, 0x9b,
        0x47, 0x12, 0x1f, 0x1f, 0x49, 0x66, 0xd4, 0xd0,
    ...
    it "should decrypt case 3 in ECB mode" do
      u = AES::Utils.new(256, AES::Mode::ECB, AES::Process::Decrypt)
      ciphertext = [
    ...
    it "should decrypt case 3 in CBC mode" do
      u = AES::Utils.new(256, AES::Mode::CBC, AES::Process::Decrypt)
      ciphertext = [
        0xe4, 0x51, 0x83, 0xee, 0xa6, 0x2d, 0x1e, 0xdd,
        0xc5, 0x14, 0x8a, 0x63, 0xe0, 0x0b, 0x08, 0xb2,
    ...
    it "should decrypt case 4 in ECB mode" do
      u = AES::Utils.new(128, AES::Mode::ECB, AES::Process::Decrypt)
      ciphertext = [
    ...
    it "should decrypt case 4 in CBC mode" do
      u = AES::Utils.new(128, AES::Mode::CBC, AES::Process::Decrypt)
      ciphertext = [
        0x4d, 0x5a, 0x64, 0xe1, 0xab, 0x11, 0xc8, 0xb8,
        0x5d, 0x40, 0x9a, 0x65, 0xb8, 0x6c, 0xa2, 0x6b,
    ...
    it "should decrypt case 5 in ECB mode" do
      u = AES::Utils.new(192, AES::Mode::ECB, AES::Process::Decrypt)
      ciphertext = [
    ...
    it "should decrypt case 5 in CBC mode" do
      u = AES::Utils.new(192, AES::Mode::CBC, AES::Process::Decrypt)
      ciphertext = [
        0xa4, 0x7c, 0x9a, 0x1f, 0xaa, 0x57, 0x5e, 0x85,
        0xa0, 0xc6, 0x1c, 0x9f, 0x77, 0x35, 0xc0, 0x59,
    ...
    it "should decrypt case 6 in ECB mode" do
      u = AES::Utils.new(256, AES::Mode::ECB, AES::Process::Decrypt)
      ciphertext = [
    ...
    it "should decrypt case 6 in CBC mode" do
      u = AES::Utils.new(256, AES::Mode::CBC, AES::Process::Decrypt)
      ciphertext = [
        0x57, 0x2b, 0x50, 0x2e, 0xc1, 0x28, 0xb9, 0x66,
        0xd5, 0xf5, 0x9a, 0x1c, 0x21, 0xa2, 0x31, 0xd6,
    ...
    it "should decrypt case 7 in ECB mode" do
      u = AES::Utils.new(128, AES::Mode::ECB, AES::Process::Decrypt)
      ciphertext = [
    ...
    it "should decrypt case 7 in CBC mode" do
      u = AES::Utils.new(128, AES::Mode::CBC, AES::Process::Decrypt)
      ciphertext = [
        0x8d, 0x00, 0x7c, 0xbc, 0x64, 0xca, 0xb7, 0x65,
        0xdc, 0xa0, 0x80, 0xf8, 0xad, 0x73, 0xae, 0xf4,
    ...
    it "should decrypt case 8 in ECB mode" do
      u = AES::Utils.new(192, AES::Mode::ECB, AES::Process::Decrypt)
      ciphertext = [
    ...
    it "should decrypt case 8 in CBC mode" do
      u = AES::Utils.new(192, AES::Mode::CBC, AES::Process::Decrypt)
      ciphertext = [
        0x1c, 0x47, 0xec, 0xad, 0xae, 0xf8, 0x96, 0x48,
        0x08, 0x5c, 0xdb, 0x40, 0x94, 0x9f, 0x5f, 0xc9,
    ...
    it "should decrypt case 9 in ECB mode" do
      u = AES::Utils.new(256, AES::Mode::ECB, AES::Process::Decrypt)
      ciphertext = [
    ...
    it "should decrypt case 9 in CBC mode" do
      u = AES::Utils.new(256, AES::Mode::CBC, AES::Process::Decrypt)
      ciphertext = [
        0xe7, 0xf5, 0x66, 0x7b, 0xb6, 0x1f, 0x4f, 0x31,
        0xdc, 0x45, 0xd1, 0x47, 0x10, 0xaf, 0x70, 0x12,
